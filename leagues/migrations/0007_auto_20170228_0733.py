# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2017-02-28 12:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('leagues', '0006_auto_20170227_2347'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='league',
            name='division',
            field=models.IntegerField(choices=[(1, 'Sunday D1'), (2, 'Sunday D2'), (3, 'Wednesday Draft League')], max_length=30, null=True),
        ),
        migrations.AlterField(
            model_name='player',
            name='email',
        ...
        migrations.AlterField(
            model_name='roster',
            name='player',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='leagues.Player'),
        ),
        migrations.AlterField(
            model_name='season',
            name='year',
